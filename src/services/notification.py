...
class FeishuNotifier(NotificationService):
    ...
    async def send_simple_text(self, webhook_url: str, text: str) -> bool:
        """发送简单文本通知"""
            ...
            "attachments": [
                {
                    ...
                    "fields": [
                        ...
                        {"title": "Current Usage", "value": f"${current_cost:.4f}", "short": True},
                        {"title": "Budget Limit", "value": f"${budget_amount:.4f}", "short": True},
                        {
