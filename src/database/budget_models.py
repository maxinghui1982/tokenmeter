...
class Budget(Base):
    ...
    def to_dict(self):
        ...
        return {
            ...
            "period": self.period,
            "alert_thresholds": json.loads(self.alert_thresholds)
...
class BudgetCalculator:
    ...
    def calculate_current_usage(self, budget: Budget) -> dict:
        ...
        ).filter(UsageRecord.timestamp >= period_start, UsageRecord.timestamp < period_end)
    ...
    def check_budget_thresholds(self, budget: Budget) -> list:
        ...
        thresholds = (
            json.loads(budget.alert_thresholds) if budget.alert_thresholds else [50, 80, 100]
        )
        triggered = []
